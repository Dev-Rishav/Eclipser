...
const Communications = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-space-void via-space-dark to-space-darker">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-200px)]">
          ...
          {/* Chat Sidebar */}
          <div className="lg:col-span-1 bg-gradient-to-b from-space-darker/80 to-space-dark/80 rounded-2xl border border-stellar-blue/30 overflow-hidden">
          ...
          <div className="lg:col-span-2">
            {selectedChat ? (
              <div className="bg-gradient-to-b from-space-darker/80 to-space-dark/80 rounded-2xl border border-stellar-blue/30 h-full flex flex-col overflow-hidden">
                
                {/* Chat Header */}
                <div className="p-4 border-b border-stellar-blue/20 bg-gradient-to-r from-space-darker/50 to-space-dark/50">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <button
                ...
                {/* Message Input */}
                <div className="p-4 border-t border-stellar-blue/20 bg-gradient-to-r from-space-darker/50 to-space-dark/50">
              ...
              // Welcome Screen
              <div className="bg-gradient-to-b from-space-darker/80 to-space-dark/80 rounded-2xl border border-stellar-blue/30 h-full flex items-center justify-center">
